    ...
    def draw(
        ...
        **kwargs,
        ...
        ordering : {'sort', None, 'random'}, optional
            ...
            :meth:`quimb.tensor.tn1d.tebd.LocalHam2D.get_auto_ordering`
...
class TEBD2D(
    ...
    gate_opts : dict, optional
        ...
        :meth:`quimb.tensor.tnag.core.TensorNetworkGenVector.gate_`.
    ordering : None, str or callable, optional
        ...
        :meth:`quimb.tensor.tnag.tebd.LocalHam2D.get_auto_ordering`,
    ...
    compute_energy_opts : dict, optional
        ...
        :meth:`~quimb.tensor.tn2d.core.PEPS.compute_local_expectation`.
...
class SimpleUpdate(
    ...
    gate_opts : dict, optional
        Other options to supply to the gate application method,
        :meth:`quimb.tensor.tnag.core.TensorNetworkGenVector.gate_simple_`.
    ordering : None, str or callable, optional
        The ordering of the terms to apply, by default this will be determined
        automatically. It can be a string to be supplied to
        :meth:`quimb.tensor.tnag.tebd.LocalHamGen.get_auto_ordering`,
        a callable which returns an ordering when called, or a fixed sequence
        of coordinate pairs.
    second_order_reflect : bool, optional
        Whether to use a second order Trotter decomposition by reflecting the
...
class FullUpdate(TEBD2D):
    ...
    gate_opts : dict, optional
        Supplied to :meth:`quimb.tensor.tn2d.core.TensorNetwork2DVector.gate`,
    ...
    ordering : str, tuple[tuple[int]], callable, optional
        ...
        strategy given to
        :meth:`~quimb.tensor.tn1d.tebd.LocalHam2D.get_auto_ordering`. An
    ...
    compute_energy_opts : dict, optional
        Supplied to
        :meth:`~quimb.tensor.tn2d.core.PEPS.compute_local_expectation`. By
